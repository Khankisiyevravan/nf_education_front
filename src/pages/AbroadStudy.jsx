...
function AbroadStudy() {
  return (
    <>
      <main>
        <section
          class="hero_banner style_2 mouse_move"
                ...
                <div class="banner_image_2">
                  <div class="image_wrap_1">
                    <div class="layer" data-depth="0.1">
                      <img
                        src="/images/banner/hero_banner_img_2.png"
                  ...
                  <div class="child_image image_wrap_2">
                    <div class="layer" data-depth="0.3">
                      <img
                        src="/images/banner/hero_banner_img_3.jpg"
                        alt="Collab – Online Learning Platform"
                      />
                    </div>
                  </div>
                  <div class="child_image image_wrap_3">
                    <div class="layer" data-depth="0.2">
                      <img
                        src="/images/banner/hero_banner_img_4.jpg"
                        alt="Collab – Online Learning Platform"
                      />
                    </div>
                  </div>
                  <div class="child_image image_wrap_4">
                    <div class="layer" data-depth="0.4">
                      <img
                        src="/images/banner/hero_banner_img_5.jpg"
                        alt="Collab – Online Learning Platform"
                      />
                    </div>
                  </div>
        ...
        <section class="courses_section section_space_lg">
          <div class="container">
                ...
                <div class="course_card style_2">
                  <div class="item_image">
                    <a href="course_details.html" data-cursor-text="View">
                      <img
                        src="/images/course/course_image_4.jpg"
                        alt="Collab – Online Learning Platform"
                      />
                    </a>
                  </div>
              ...
              <div class="col col-lg-4">
                <div class="course_card style_2">
                  <div class="item_image">
                    <a href="course_details.html" data-cursor-text="View">
                      <img
                        src="/images/course/course_image_5.jpg"
                        alt="Collab – Online Learning Platform"
                      />
                    </a>
                  </div>
            ...
            <div class="btn_wrap d-block d-lg-none pb-0 text-center">
              <a class="btn border_dark" href="course.html">
                <span>
                  <small>Explore Courses</small> <small>Explore Courses</small>
                </span>
              </a>
            </div>
          </div>
          ...
          <div class="container position-relative">
            ...
            <div class="intro_video">
              <div class="video_wrap tilt">
                ...
                />{" "}
                <a
                  class="video_play_btn popup_video"
              ...
              >
                <div class="carousel_item">
                  <div class="testimonial_item_2">
                    <div
                      class="testimonial_image ms-0"
                      style={{ backgroundImage: "url(/images/shape/shape_img_6.svg)" }}
                      // style="background-image:url(/images/shape/shape_img_6.svg)"
                    >
                      <img
                        src="/images/testimonial/testimonial_img_3.png"
                        alt="Collab – Online Learning Platform"
                      />
                    </div>
                ...
                <div class="calltoaction_form">
                  <form action="#">
                    ...
                    <div class="form_item">
                      <label
                        for="input_name"
                        class="input_title text-uppercase"
                      >
                        Name
                      </label>{" "}
                      <input
          ...
          <div class="container">
            ...
            <ul class="brands_logo_list unordered_list">
              <li>
                <a href="#!">
                  <img
                    src="/images/brands/logo_microsoft.png"
                    alt="Microsoft"
                  />
                </a>
              </li>
              <li>
                <a href="#!">
                  <img
                    src="/images/brands/logo_alphabet.png"
                    alt="Alphabet"
                  />
                </a>
              </li>
              <li>
                <a href="#!">
                  <img src="/images/brands/logo_intel.png" alt="Intel" />
                </a>
              </li>
              <li>
                <a href="#!">
                  <img src="/images/brands/logo_cisco.png" alt="Cisco" />
                </a>
              </li>
              <li>
                <a href="#!">
                  <img
                    src="/images/brands/logo_verizon_communications.png"
                    alt="Verizon Communications"
                  />
                </a>
              </li>
              <li>
                <a href="#!">
                  <img
                    src="/images/brands/logo_infopulse.png"
                    alt="Infopulse.png"
                  />
                </a>
              </li>
              <li>
                <a href="#!">
                  <img
                    src="/images/brands/logo_amazon.png"
                    alt="Amazon"
                  />
                </a>
              </li>
              <li>
                <a href="#!">
                  <img
                    src="/images/brands/logo_wix_com_website.png"
                    alt="Wix"
                  />
                </a>
              </li>
