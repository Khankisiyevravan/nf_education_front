                  ...
                  <div className="pe-lg-5">
                    <div className="course_info_card d-lg-none">
                      <div className="details_image">
                        <img
                          src="/images/course/course_details_image_1.jpg"
                            ...
                            <div className="accordion-body">
                              ...
                              <div className="intro_video mb-3">
                                <div className="video_wrap">
                                  <img
                                    src="/images/video/video_poster_3.jpg"
                                    alt="Collab – Online Learning Platform"
                                  />
                                  <a
                              ...
                              >
                                <span>
                                  ...
                                  <small>
                                    <img
                                      src="/images/icon/icon_clip_white.svg"
                                      alt="Collab – Online Learning Platform"
                                    />
                                    Resources
                                  </small>
                          ...
                          <div className="comment_item">
                            <div className="comment_author">
                              <div className="author_thumbnail">
                                <img
                                  src="/images/meta/student_thumbnail_6.jpg"
                                  alt="Collab – Online Learning Platform"
                                />
                              </div>
                        ...
                        <li>
                          <div className="comment_item">
                            <div className="comment_author">
                              <div className="author_thumbnail">
                                <img
                                  src="/images/meta/student_thumbnail_7.jpg"
                                  alt="Collab – Online Learning Platform"
                                />
                              </div>
                              <div className="author_content">
                    ...
                    <ul className="course_list unordered_list_block">
                      <li>
                        ...
                        >
                          <span className="item_image">
                            <img
                              src="/images/course/course_image_15.jpg"
                              alt="Collab – Online Learning Platform"
                            />{" "}
                          </span>
                      ...
                      <li>
                        ...
                        >
                          <span className="item_image">
                            <img
                              src="/images/course/course_image_16.jpg"
                              alt="Collab – Online Learning Platform"
                            />{" "}
                          </span>
                          <span className="item_content">
                      ...
                      <li>
                        ...
                        >
                          <span className="item_image">
                            <img
                              src="/images/course/course_image_17.jpg"
                              alt="Collab – Online Learning Platform"
                            />{" "}
                          </span>
                          <span className="item_content">
